...
from hummingbot.strategy.liquidity_mining_variant.liquidity_mining import LiquidityMiningStrategyVariant
from hummingbot.strategy.liquidity_mining_variant.liquidity_mining_variant_config_map import liquidity_mining_variant_config_map as c_map
...
def start(self):
    ...
    self.strategy = LiquidityMiningStrategyVariant(
        exchange=exchange,
